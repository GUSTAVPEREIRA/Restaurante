    ...
    private void OnActionGravar(ActionEvent event) {
        ...
        if (erro != true) 
        {
            ...
            {               
                ...
                dialogoExe.setHeaderText("Nova cidade: "+cidade.getNome()+" inserida.");
            }
            else
            {
                cidadeDAO.alterar(cidade);
                dialogoExe.setHeaderText("Cidade: "+cidade.getNome()+" alterada.");
            }
            ...
            if (b == btnSim)
            {
                if (txt_codigo.getText().equals("0") != true && !txt_codigo.getText().isEmpty()) 
                {
                  ...
                  if (deletado == true) 
                  {
                    ...
                    alert.setContentText("Cidade "+cidade.getNome()+" Excluido");
                    alert.show();             
                    desativaTela();
                  }
                  else
                  {
                    alert.setContentText("Cidade "+cidade.getNome()+" não pode ser excluido, verifique se há pessoas com está cidade.");
                    alert.show();       
                  }
                }     
            }
